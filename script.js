  ...
  function validate(){
         ...
         function checkpalin(event){
           ...
           let divmessage = document.getElementById("divmessage");
            ...
            if(bPalin){
                divmessage.textContent = "The word/phrase is a palindrome.";
            } 
            
            else {
                divmessage.textContent = "The word/phrase is not a palindrome.";
            }
        }
        ...
        // set attibets of our new html element

        audioElement.setAttribute("id", "myAudio");

        audioElement.setAttribute("src", "hitslab-magic-mystery-harry-potter-music-320643.mp3");
         ...
         document.getElementById("btnpauseaudio").hidden = true;
